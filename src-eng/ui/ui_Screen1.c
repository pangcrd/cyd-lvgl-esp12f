...
void ui_Screen1_screen_init(void)
{
    ...
    //lv_label_set_text(ui_Label2, "No device connected !");
    lv_label_set_text_fmt(ui_Label2, "%s  %s", LV_SYMBOL_CLOSE, "No device connected !");
    ...
    lv_label_set_text(ui_Label4, "CONNECTED DEVICE INFO");
